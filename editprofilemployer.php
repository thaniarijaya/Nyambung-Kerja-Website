...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($err)){
        ...
        $sql = "UPDATE employer SET email='$email', alamat='$alamat', no_telp='$no_telp', lokasi_id='$lokasi_id' WHERE username='$username'";
...
<nav class="navbar navbar-expand-sm">
    <div class="container">
    <a href="profilemployer.php" class="previous">&#8249;</a>
    </div>
</nav>
...
<div class="modal-dialog modal-dialog-centered">
        ...
        <form id="pilihProfil" action="gantiProfilemployer.php" method="POST">
            <div class='container'>
            <?php
                $username = $_SESSION["username"];
                $sql = "SELECT foto_id FROM employer WHERE username = '$username'";
                $hasil = $conn->query($sql);

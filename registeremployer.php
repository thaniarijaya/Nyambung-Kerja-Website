...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty(trim($_POST["username"]))) {
        ...
        $sql = "SELECT employer_id FROM employer WHERE username = ?";
    ...
    if (empty($username_err) && empty($password_err) && empty($confirm_password_err) && empty($email_err) && empty($alamat_err) && empty($no_telp_err) && empty($lokasi_id_err)) {
        ...
        $sql = "INSERT INTO employer (username, password, email, alamat, no_telp, lokasi_id, foto_id) VALUES ('$username', '$password', '$email', '$alamat', '$no_telp', '$lokasi_id', '$foto_id');";
...
<head>
    ...
    <title>Sign Up as Employer</title>
...
<body>
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <p>Already have an account? <a href="loginemployer.php">Login here</a>.</p>
        </form>
    </div>
        </div>

        ...
        <div class="jumbotron my-auto bg-cover">
            ...
            <form class="input-group">
                ...
                <div class="input-group-append">
                    <a class="input-group-text"><i class="bi bi-search"></i></a>
                </div>
...
if(isset($_GET['cari'])){
	$cari = $_GET['cari'];
    if($cari != ''){
	    $sql = mysqli_query($conn, "SELECT * FROM lowongan low JOIN employer emp on low.employer_id = emp.employer_id JOIN lokasi lok ON emp.lokasi_id = lok.lokasi_id join pend_akhir pend on low.pend_akhir_id = pend.pend_akhir_id WHERE low.judul_lowongan
        LIKE '%$cari%' OR low.posisi_jabatan LIKE '%$cari%' OR low.nama_perusahaan LIKE '%$cari%'");
    } else{
        $sql = mysqli_query($conn, "SELECT * FROM lowongan low JOIN employer emp on low.employer_id = emp.employer_id JOIN lokasi lok ON emp.lokasi_id = lok.lokasi_id join pend_akhir pend on low.pend_akhir_id = pend.pend_akhir_id");
    }
...
<div class="col-9 col-sm">
    <div class="card p-3">
        ...
        <ul>
            ...
            <li><i class="bi bi-coin"></i> <?php echo 'IDR '. $data['gaji_min'] . ' - ' . 'IDR ' . $data['gaji_max']; ?></li>

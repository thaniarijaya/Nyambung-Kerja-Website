...
<body>
    ...
    if ($hasilquery->num_rows > 0) {
        while ($row = mysqli_fetch_array($hasilquery)) { ?>
            ...
            <form action="insertdaftar.php" method="post" enctype="multipart/form-data">
                <div class="container">
                    <br>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="nama" name="nama" autocomplete="none">
                            </div>
                        </div>
                    </div>
                    ...
                    <br>
                    <center>
                        <button type="submit" style="background-color: #23049D; color: white;" class="btn btn-primary btn-lg btn-block" onclick="alertFunc()">Submit</button>
                    </center>
                    <br>
                </div>
            </form>
